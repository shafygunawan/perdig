...
<head>
  ...
  <title>Edit Employee | Perdig</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form action="<?= $baseUrl; ?>/employees/update.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $user["id"]; ?>">
                <input type="hidden" name="old_profile_path" value="<?= $user["profile_path"]; ?>">
                ...
                <div class="mb-3">
                  ...
                  <select class="custom-select" id="level" name="level">
                    <option <?= ($user["level"] === "employee" ? "selected" : ""); ?> value="employee">Employee</option>
