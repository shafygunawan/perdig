...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link disabled" href="<?= $baseUrl; ?>/employees/index.php">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-2 mb-sm-0 text-gray-800">Employees</h1>
            <a href="<?= $baseUrl; ?>/employees/report.php" target="_blank" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Print Report</a>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row justify-content-between">
                <div class="col-sm mb-sm-0 mb-3">
                  ...
                  <a href="<?= $baseUrl; ?>/employees/add.php" class="btn btn-primary btn-sm ml-2">
                ...
                <div class="col-sm-auto">
                  <form class="form-inline mw-100 search-form">
                    <div class="input-group">
                      <input type="search" class="form-control form-control-sm small" placeholder="Cari karyawan . . ." aria-label="Search" aria-describedby="basic-addon2">
            ...
            <div class="card-body">
              <form action="<?= $baseUrl; ?>/employees/delete.php" method="POST" class="multiple-delete-form">
                  ...
                  <table class="table" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      <?php foreach ($users as $user) : ?>
                        <tr>
                          <td>
                            <input type="checkbox" class="check-item" name="user_ids[]" value="<?= $user["id"]; ?>">
                          </td>
                          <td><?= "{$user["first_name"]} {$user["last_name"]}"; ?></td>
                          <td><?= $user["email"]; ?></td>
                          <td><?= ucwords($user["level"]); ?></td>
                          <td>
                            <a href="<?= $baseUrl; ?>/employees/edit.php?id=<?= $user["id"]; ?>" class="btn btn-link btn-sm py-0 edit-btn edit-btn-hide">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to delete a employee?</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">Click "Delete" below if you are sure to delete the selected employee. (this action cannot be undone)</div>
  ...
  <script>
    ...
    const ENDPOINT = '/employees/search.php';
  </script>
