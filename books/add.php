      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form action="<?= $baseUrl; ?>/books/save.php" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="release-year" name="release_year" min="1901" max="<?= date("Y"); ?>" required>
                </div>
