      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form action="<?= $baseUrl; ?>/books/update.php" method="POST">
                ...
                <div class="mb-3">
                  <label for="release-year" class="form-label">Release Year <span class="text-danger">*</span></label>
                  <input type="number" class="form-control" id="release-year" name="release_year" min="1901" max="<?= date("Y"); ?>" value="<?= $book["release_year"]; ?>" required>
                </div>
                <div class="row justify-content-end mt-5">
                  ...
                  <div class="col-sm-auto">
                    <a href="<?= $baseUrl; ?>/books/index.php" class="btn btn-danger w-100">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
